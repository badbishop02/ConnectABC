    ...
    <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12">
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
                    <Link href="/">
                    <p className="transition duration-500 ease hover:bg-black-500 inline-block bg-purple-600 text-lg rounded-full text-white px-8 py-3 cursor-pointer">
                    ⌂ Home
                    </p>
                    </Link>
                    <Link href="/contact">
                    <button className="transition duration-500 ease hover:bg-black-500 inline-block bg-purple-600 text-lg rounded-full text-white px-8 py-3 cursor-pointer">
                    🤙 Contact us
                    </button>
                    </Link>
                    <p className="hover:text-white-300 text-base cursor-pointer leading-4 text-white">
                    <Link href="/subscribe">
                    <button
                       className="transition duration-500 ease hover:bg-black-500 inline-block bg-purple-600 text-lg rounded-full text-white px-8 py-3 cursor-pointer"
                    >
                ...
                <div className="flex items-center mt-6">
                    <p className="text-base leading-4 text-white">
                       @ 2022. <span className="font-semibold">Connecting Souls</span>
                    </p>
