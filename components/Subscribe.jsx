    ...
    <div className="container mx-auto">
      <div>
        <div id="title" class="text-center my-4">
          ...
          <input type="tel" placeholder="Phone number" name="phonenumber" className="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-white focus:border-blue-600 focus:outline-none focus:ring-0" />
